...
export default function TelaDenuncia() {
  ...
  const [imagem, setImagem] = useState(null); // você pode integrar ImagePicker depois
...
const styles = StyleSheet.create({
  ...
  formContainer: {
    ...
    borderRadius: 20,
    padding: 24,
    paddingTop: 60, // Aumenta o espaço superior
    width: '100%',
    alignItems: 'center',
    gap: 20,
    position: 'relative',
